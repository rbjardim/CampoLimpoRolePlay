 ...
 * Further Regras can be found in Spanish on http://es.wikipedia.org/wiki/C%C3%B3digo_de_identificaci%C3%B3n_fiscal
 *
...
$.validator.addMethod( "require_from_group", function( value, element, options ) {
	...
	// If element isn't being validated, run each require_from_group field's validation Regras
...
$.validator.addMethod( "skip_or_fill_minimum", function( value, element, options ) {
	...
	// If element isn't being validated, run each skip_or_fill_minimum field's validation Regras
	if ( !$( element ).data( "being_validated" ) ) {
		$fields.data( "being_validated", true );
		$fields.each( function() {
			validator.element( this );
